...
namespace Apigee\Edge\Api\Docstore\Normalizer;

use Apigee\Edge\Api\Docstore\Entity\DocstoreEntityInterface;
use Apigee\Edge\Api\Docstore\NameConverter\DocstoreNameConverter;
...
class DocstoreNormalizer extends ObjectNormalizer
{
    /**
     * DocstoreNormalizer constructor.
     *
    ...
    {
        $nameConverter = $nameConverter ?? new DocstoreNameConverter();
    ...
    {
        return $data instanceof DocstoreEntityInterface;
    }
}
