...
trait PreviousRatePlanRevisionPropertyAwareTrait
{
    /**
    ...
    {
        return $this->previousRatePlanRevision;
    }
     ...
     * @internal
     */
    public function setPreviousRatePlanRevision(RatePlanInterface $previousRatePlanRevision): void
    {
        $this->previousRatePlanRevision = $previousRatePlanRevision;
    }
}
