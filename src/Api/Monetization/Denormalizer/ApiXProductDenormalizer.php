...
class ApiXProductDenormalizer extends ObjectDenormalizer
{
    /**
     * ApiXProductDenormalizer constructor.
     *
    ...
    public function supportsDenormalization($data, $type, $format = null)
    {
        ...
        return ApiXProductInterface::class === $type || $type instanceof ApiXProductInterface || in_array(ApiXProductInterface::class, class_implements($type));
    }
}
