...
use Apigee\Edge\Api\Monetization\NameConverter\AddressNameConverter;
...
final class AddressDenormalizer extends ObjectDenormalizer
{
    /**
    ...
    {
        $nameConverter = $nameConverter ?? new AddressNameConverter();
    ...
    public function supportsDenormalization($data, $type, $format = null)
    {
        ...
        return Address::class === $type || $type instanceof Address;
    }
}
