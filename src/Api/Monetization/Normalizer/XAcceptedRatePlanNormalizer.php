...
class XAcceptedRatePlanNormalizer extends EntityNormalizer
{
    ...
    {
        /** @var \Apigee\Edge\Api\Monetization\Entity\XAcceptedRatePlanInterface $object */
    ...
    {
        return $data instanceof XAcceptedRatePlanInterface;
    }
}
