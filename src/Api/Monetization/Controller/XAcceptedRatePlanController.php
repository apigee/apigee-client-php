...
use Apigee\Edge\Api\Monetization\Serializer\XAcceptedRatePlanSerializer;
...
abstract class XAcceptedRatePlanController extends OrganizationAwareEntityController implements XAcceptedRatePlanControllerInterface
{
    ...
    /**
     * XAcceptedRatePlanController constructor.
     *
    ...
    {
        $entitySerializer = $entitySerializer ?? new XAcceptedRatePlanSerializer();
    ...
    public function acceptRatePlan(RatePlanInterface $ratePlan, DateTimeImmutable $startDate, ?DateTimeImmutable $endDate = null, ?int $quotaTarget = null, ?bool $suppressWarning = null, ?bool $waveTerminationCharge = null): XAcceptedRatePlanInterface
    {
        ...
        /** @var \Apigee\Edge\Api\Monetization\Entity\XAcceptedRatePlanInterface $acceptedRatePlan */
    ...
    private function getAcceptedRatePlans(array $query_params = []): array
    {
        ...
        foreach ($this->getRawList($this->getAcceptedRatePlansEndpoint()->withQuery(http_build_query($query_params))) as $item) {
            ...
            $tmp = $this->getEntitySerializer()->denormalize(
                $item,
                XAcceptedRatePlanInterface::class,
                'json'
            );
