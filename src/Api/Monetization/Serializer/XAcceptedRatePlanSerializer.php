...
use Apigee\Edge\Api\Monetization\Denormalizer\XDeveloperAcceptedRatePlanDenormalizer;
use Apigee\Edge\Api\Monetization\Normalizer\XAcceptedRatePlanNormalizer;
use Apigee\Edge\Api\Monetization\Normalizer\CompanyAcceptedRatePlanNormalizer;

class XAcceptedRatePlanSerializer extends EntitySerializer
{
    /**
     * @inheritDoc
     */
    public static function getEntityTypeSpecificDefaultNormalizers(): array
    {
        ...
        return array_merge(
            [
                ...
                new XDeveloperAcceptedRatePlanDenormalizer(),
                new XAcceptedRatePlanNormalizer(),
            ],
