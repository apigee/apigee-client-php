...
class AppGroupAcceptedRatePlanDenormalizer extends AcceptedRatePlanDenormalizer
{
    /**
     * Fully qualified class name of the appgroup accepted rate plan entity.
     *
     * @var string
     */
    protected $appGroupAcceptedRatePlanClass = AppGroupAcceptedRatePlan::class;
    ...
    public function supportsDenormalization($data, $type, $format = null)
    {
        ...
        return is_a($type, AppGroupAcceptedRatePlanInterface::class, true);
    }
}