 ...
 * @group monetization
 */
class DeveloperBillingTypeControllerTest extends BillingTypeControllerTestBase
{
    ...
    protected static function entityController(?ClientInterface $client = null): EntityControllerTesterInterface
    {
        ...
        return new EntityControllerTester(new DeveloperBillingTypeController(static::$testDeveloperId, static::defaultTestOrganization($client), $client));
    }
}
