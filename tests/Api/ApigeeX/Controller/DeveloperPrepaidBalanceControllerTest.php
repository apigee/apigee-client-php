...
use Apigee\Edge\Api\ApigeeX\Controller\DeveloperPrepaidBalanceController;
...
class DeveloperPrepaidBalanceControllerTest extends PrepaidBalanceControllerTestBase
{
    ...
    protected static function entityController(ClientInterface $client = null): EntityControllerTesterInterface
    {
        ...
        return new EntityControllerTester(new DeveloperPrepaidBalanceController(self::$developerId, static::defaultTestOrganization($client), $client));
    }
}
