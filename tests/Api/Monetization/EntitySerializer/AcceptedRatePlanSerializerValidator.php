...
use Apigee\Edge\Tests\Api\Monetization\EntitySerializer\PropertyValidator\RatePlanEntityReferencePropertyValidator;

class AcceptedRatePlanSerializerValidator extends OrganizationAwareEntitySerializerValidator
{
    /**
