...
trait CompanyAppControllerAwareTestTrait
{
    ...
    protected static function companyAppController(ClientInterface $client = null): EntityControllerTesterInterface
    {
        ...
        return new EntityControllerTester(new CompanyAppController(static::defaultTestOrganization($client), static::companyAppControllerCompanyAppOwner()->id(), $client));
    }

    abstract protected static function companyAppControllerCompanyAppOwner(): CompanyInterface;
}
