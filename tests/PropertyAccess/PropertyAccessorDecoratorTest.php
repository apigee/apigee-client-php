...
class PropertyAccessorDecoratorTest extends PropertyAccessorTest
{
    ...
    protected function setUp(): void
    {
        ...
        // class.
        $ro = new \ReflectionClass('Symfony\Component\PropertyAccess\Tests\PropertyAccessorTest');
        $property = $ro->getProperty('propertyAccessor');
        $property->setAccessible(true);
        $property->setValue($this, $this->propertyAccessor);
    }

    public function testGetValueWithInvalidReturnValueType(): void
    {
        // TODO
        $this->markTestIncomplete();
    }

    public function testSetValueWithVariableLengthArgumentsExpected(): void
    {
        // TODO
        $this->markTestIncomplete();
    }
